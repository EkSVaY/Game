...
def story_line():
    ...
    print("\nВам предстоит сделать сложный выбор: какую сторону конфликта на Аракисе будете представлять именно вы?\n"
          "1) Фримены - коренное население Аракиса. За долгие годы жизни в пустынных условиях полностью к ним приспособились.\n"
          "Умеют перерабатывать различные жидкости в питьевую воду. Разрозненные племена фрименов живут в разных местах Аракиса\n"
          "Являются настоящими владельцами Аракиса, ведь приручили самого сверепого хищника этих земель - Шаи-Хулуда. Подвержены\n"
...
def h_part_1(rep, army, tech, spice):
    ...
    if shot == 1:
        ...
        print("\nВы оказались не готовы к неожиданному нападению Фрименов! Вы потеряли своих бойцов и с позором вернулись\n"
